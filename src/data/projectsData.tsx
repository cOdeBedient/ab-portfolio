let projectsData: { name: string, thumbnail: string, tagline: string, deployed?: string, repo?: string, login?: string}[] = 
    [
        {
        ...
        },
        {
            ...
            tagline: "Organize and book trips on this vanilla JavaScript app.",
            deployed: 'https://codebedient.github.io/Up-and-A-w-a-y/',
            repo: 'https://github.com/cOdeBedient/Up-and-A-w-a-y',
            login: 'username: traveler18 | pw: traveler'
        },
        {
            name: "bLOOMbABY",
